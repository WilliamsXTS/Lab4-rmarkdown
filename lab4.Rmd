...
This data set contains `r nrow(ih)` and `r ncol(ih)`
The variables in this data set are:`r str_flatten_comma(names(ih), last = ", and")`
...
The variables in theis dataset are:`r str_flatten_comma(names(ih), last = ", and")`
...
“age”, 4 missings in ....2 Do taller people earn more?

Missing values:
*income variable*: `r sum(is.na(ih$income))`
*height variable*: `r sum(is.na(ih$height))`

1. Find the average height in data. Answer in a complete sentence, round the result as appropriate.
